...
# cnunes
# Gabrielle Shyrolyn Nyce
# gnyce
# Kyra Rose Keenan
# kkeeenan
# Lester Ellsworth Ault V
# aultl
# Section: 3
# Team: 38
#
...
# ---------------------------------------------------
if rSide <= 600:
    if pumpIndex == -1 or pipeIndex == -1 or bend1Index == -1 or bend2Index == -1 or turbineIndex == -1 or \
            diameterIndex == -1 or performanceIndex == -1:
